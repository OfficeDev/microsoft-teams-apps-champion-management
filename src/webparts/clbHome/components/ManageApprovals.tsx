...
export default class ManageApprovals extends Component<
  IManageApprovalsProps,
  IManageApprovalsState
> {
  ...
  public componentDidUpdate(
    prevProps: Readonly<IManageApprovalsProps>,
    prevState: Readonly<IManageApprovalsState>,
    snapshot?: any
  ): void {
  ...
  _customRenderer(
    ...
    return (
      <span>
        ...
        <img
          src={require(`../assets/CMPImages/BellIcon.svg`)}
  ...
  public render() {
    ...
    return (
      <div
        className={`container ${styles.manageApprovalsContainer}${
          isDarkOrContrastTheme
            ? " " + styles.manageApprovalsContainerDarkContrast
            : ""
        }`}
      >
        <div className={styles.manageApprovalsPath}>
          ...
          <span className={styles.manageApprovalsLabel}>
        ...
        >
          <PivotItem
            ...
            itemKey="0"
            onRenderItemLink={
              this.state.isPendingChampionApproval
                ? this._customRenderer
                : this._customRendererNoIcon
            }
            ariaLabel={
              navigator.userAgent.match(/Android/i)
                ? `${LocaleStrings.ChampionsListPageTitle} 1 of 3`
                : ""
            }
          >
          ...
          <PivotItem
            ...
            itemKey="1"
            onRenderItemLink={
              this.state.isPendingEventApproval
                ? this._customRenderer
                : this._customRendererNoIcon
            }
            ariaLabel={
              navigator.userAgent.match(/Android/i)
                ? `${LocaleStrings.ChampionActivitiesLabel} 2 of 3`
                : ""
            }
          >
          ...
          <PivotItem
            ...
            ariaLabel={
              navigator.userAgent.match(/Android/i)
                ? `${LocaleStrings.ManageConfigSettingsLabel} 3 of 3`
                : ""
            }
          >
