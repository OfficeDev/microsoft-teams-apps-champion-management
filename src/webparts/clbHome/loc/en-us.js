define([], function () {
  return {
    ...
    "ManageToTLabel1": "Multiple tournaments can be enabled at a time. See below for the current active tournaments, ability to end the tournament, as well as the ability to start a new tournament.",
    ...
    "EndTournamentDialogMessage": "Are you sure want to end the tournament?",
    "StartTournamentDialogMessage": "Are you sure want to start the new tournament?",
    "ConfirmLabel": "Confirm",
    "YesButton": "Yes",
    "NoButton": "No",
    "ActiveTournamentLabel": "Active Tournaments",
    "EndTournamentButton": "End Tournament",
    "StartTournamentHeaderLabel": "Start Tournament",
    "StartTournamentInfoToolTip": "A new tournament can only be started if there is no active tournament. To start a new tournament end the current tournament.",
    "NoTournamentMessage": "No tournaments found.",  
    "SelectTournamentMessage": "Select a tournament to enable.",
    "NoActiveTournamentMessage": "No active tournaments found.",  
    "SelectEndTournamentMessage": "Select a tournament to end.",
    "StartTournamentButton": "Start Tournament",
    "EndTournamentSuccessMessage": "Tournament ended successfully.",
    "EnableTournamentSuccessMessage": "Tournament enabled successfully.",
